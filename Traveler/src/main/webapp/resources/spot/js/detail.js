...
function testData(data,contentTypeId) {
	...
	case "12" :
		$(".details").append("<li>문의 및 안내 : "+data[4]+"</li><br>");
		$(".details").append("<li>쉬는날 : "+data[5]+"</li><br>");
		$(".details").append("<li>이용시간 : "+data[6]+"</li><br>");
		break;
	case "14" :
		$(".details").append("<li>문의 및 안내 : "+data[4]+"</li><br>");
		$(".details").append("<li>이용요금 : "+data[5]+"</li><br>");
		$(".details").append("<li>이용시간 : "+data[6]+"</li><br>");
		break;
	case "15" :
		$(".details").append("<li>행사 홈페이지 : "+data[4]+"</li><br>");
		$(".details").append("<li>연락처 : "+data[5]+"</li><br>");
		$(".details").append("<li>공연시간 : "+data[6]+"</li><br>");
		$(".details").append("<li>이용요금 : "+data[7]+"</li><br>");
		break;
	case "25" :
		$(".details").append("<li>문의 및 안내 : "+data[4]+"</li><br>");
		$(".details").append("<li>코스 예상 소요시간 : "+data[5]+"</li><br>");
		$(".details").append("<li>코스 테마 : "+data[6]+"</li><br>");
		break;
	case "28" :
		$(".details").append("<li>문의 및 안내 : "+data[4]+"</li><br>");
		$(".details").append("<li>쉬는날 : "+data[5]+"</li><br>");
		$(".details").append("<li>이용요금 : "+data[6]+"</li><br>");
		$(".details").append("<li>이용시간 : "+data[7]+"</li><br>");
		break;
	case "32" :
		$(".details").append("<li>문의 및 안내 : "+data[6]+"</li><br>");
		$(".details").append("<li>체크인 : "+data[4]+"</li><br>");
		$(".details").append("<li>체크아웃 : "+data[5]+"</li><br>");
		$(".details").append("<li>홈페이지 : "+data[7]+"</li><br>");
		$(".details").append("<li>예약안내 : "+data[8]+"</li><br>");
		break;
	case "38" :
		$(".details").append("<li>문의 및 안내 : "+data[4]+"</li><br>");
		$(".details").append("<li>영업시간 : "+data[5]+"</li><br>");
		$(".details").append("<li>쉬는날 : "+data[6]+"</li><br>");
		break;
	case "39" :
		$(".details").append("<li>문의 및 안내 : "+data[5]+"</li><br>");
		$(".details").append("<li>대표 메뉴 : "+data[4]+"</li><br>");
		$(".details").append("<li>영업시간 : "+data[6]+"</li><br>");
