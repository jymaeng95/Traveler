				...
				<div class="container">
					...
					<div class="profile">
						...
						<div class="profile-user-settings">
							...
							<h1 class="profile-user-name" id="user-id"><c:out value="${userInfo.nickname }"></c:out></h1>
					...
					<div class="gallery">
						<c:forEach items="${b_list }" var="list">
							<div class="gallery-item" tabindex="0">
								...
								<div class="gallery-item-info" onclick="imgClick('${list.contentId}','${list.contentTypeId }');">
									<ul>
									  <!--   <li class="gallery-item-likes"><span
										...
										</span><c:out value="${list.title }"></c:out></li>
									</ul>
								</div>
							</div>
						</c:forEach>
