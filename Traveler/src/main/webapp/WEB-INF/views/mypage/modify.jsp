				...
				<form class="form-card" name="infoForm" method="post" id="infoForm">
					<fieldset class="form-fieldset">
						...
						<div class="form-element form-input">
							<input id="uid" name="userId"
								class="form-element-field" value="${userInfo.userId }"
								placeholder="Please fill in your ID" type="text"
								required readonly/>
						...
						<div class="form-element form-input form-has-error">
							...
							<div class="form-element-bar"></div>
							<label class="form-element-label"
								for="field-x98ezh-s6s2g8-vfrkgb-ngrhef-atfkop">Current Password</label>
						</div>
						<div class="form-element form-input form-has-error">
						...
						<div class="form-element form-input">
							<input id="email" name="email"
								class="form-element-field" placeholder=" " type="email" value="${email }" required />
							<div class="form-element-bar"></div>
							<label class="form-element-label"
						...
						<input type="hidden" name="c_nickname" id="cur-nickname" value="${nickname }">
						<div class="form-element form-input form-has-error">
					...
					<div class="form-actions">
						<button class="form-btn" type="button" id="btn-submit">Send inquiry</button>
